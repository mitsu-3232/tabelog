...
-- 店舗情報テーブル --
INSERT IGNORE INTO restaurants (id, name, category, image_name, description, price_high, price_low, capacity, open_time, close_time, postal_code, address, phone_number) VALUES (1, 'Rcoffee', 'カフェ', 'house01.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。長期滞在も可能です。', 3000, 1000, 6, '9:00', '19:00', '444-0867', '愛知県岡崎市明大寺町西郷中39－30', '052－561-3399');
